...
let snake1 = initSnake("purple", "Ular 1");
let snake2 = initSnake("blue", "Ular 2");
let snake3 = initSnake("black", "Ular 3");
...
function move(snake) {
    ...
    if (!checkCollision([snake1, snake2, snake3])) {
        ...
        audio.play();
        alert("Game over, "+ snake.name + " menabrak ular lain");
        ...
        if (snake == snake1) {
            ...
            snake2.speed = MOVE_INTERVAL;
            setTimeout(function() {
                move(snake2);
            }, snake2.speed);
        } else {
            snake3 = initSnake("black");
            snake3.speed = MOVE_INTERVAL;
            setTimeout(function() {
                move(snake3);
            }, snake3.speed);
        }
